...
class CardAdmin(admin.ModelAdmin):
    list_display = 'id', 'id_bank_account', 'card_number', 'turn_day', 'payment_day', 'principal', 'id_bank_account__id_titular_user',
    list_filter = ['id', 'id_bank_account',
                   'card_number', 'payment_day', 'principal',]
    search_fields = ['id', 'id_bank_account',
                     'card_number', 'payment_day', 'principal',]
    list_editable = ['id_bank_account',
                     'card_number', 'payment_day', 'turn_day', 'principal',]
    empty_value_display = 'Vazio'
    list_per_page = 20
