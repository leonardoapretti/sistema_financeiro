...
SECRET_KEY = 'django-insecure-wx-vqb6d-ezn+)ug!^#9)#$(@59svy*--&^ii%a*v@$v8lbx*#'
...
MIDDLEWARE = [
    ...
    # adiciona login_required a todas as views - url em LOGIN_URL
...
AUTH_PROFILE_MODULE = 'lancamentos.Usuario'
